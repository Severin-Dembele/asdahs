            ...
            <div className='min-h-[80vh] '>
                ...
                <section class="bg-center bg-no-repeat bg-gray-100 bg-blend-multiply">
                    <div class="px-4 mx-auto max-w-screen-xl text-center  lg:py-56">
                        ...
                        <p class="mb-8 text-lg font-normal text-black lg:text-xl sm:px-16 lg:px-48">This letter invites you to participate in a research study entitled African Seventh-day Adventist Health Study.</p>
