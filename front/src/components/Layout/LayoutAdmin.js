...
function LayoutVisitor() {
  ...
  return (
    <div>
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40 w-48 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
      >
 ...
 */}
      ...
      <div className="p-10 pt-6 sm:ml-64 lg:ml-44" style={{ paddingTop: "60px" }}>
        <Outlet />
      </div>
    </div>
  );
